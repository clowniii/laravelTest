...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<a class="btn btn-primary radius" onclick="system_category_add('添加分类','{{URL("admin/coltypes/create")}}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加分类</a>
		</span>
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			@foreach( $datas as $k => $v )
				<tr class="text-c">
					...
					<td class="f-14">
                        <a title="编辑" href="javascript:;" onclick="system_category_edit('分类编辑','{{URL('admin/coltypes/'.$v->id.'/edit')}}',{{$v->id}},'700','480')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a title="删除" href="javascript:;" onclick="system_category_del(this,'{{URL('admin/coltypes/'.$v->id)}}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
