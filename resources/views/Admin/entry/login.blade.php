...
<!--[if lt IE 9]>
<script type="text/javascript" src="{{URL::asset('admin/lib/html5shiv.js')}}"></script>
...
<meta name="description" content="中小型CMS后台系统。">
</head>
<body>
...
<div class="footer">@if( $power ) {{$power}} @endif</div>
